    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent e) {
        if (e.getName().equals("whitelist")) {
            ...
            if (!player.isWhitelisted()) {
                ...
                Button acceptButton = Button.success("request-accept[" + minecraftname + "]_" + e.getUser().getId() + ";" + plattform, DiscordWhitelist.getPlugin().getMessageFormatter().format( false,"button.accept"));
                Button denyButton = Button.danger("request-deny", DiscordWhitelist.getPlugin().getMessageFormatter().format(false, "button.deny"));
